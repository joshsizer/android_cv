...
static void ensureJniRegistered(JNIEnv *env) {
    ...
    jclass targetClass =
            env->FindClass("com/team341/daisycv/vision/ImageProcessor$TargetsInfo$Target");
...
extern "C" JNIEXPORT void JNICALL Java_com_team341_daisycv_vision_ImageProcessor_processImage(
        ...
        jint v_max,
        jobject destTargetInfo) {
    process(env, tex1, tex2, w, h, mode, h_min, h_max, s_min, s_max, v_min, v_max, destTargetInfo);
}
